...
# २. कॉम्पॅक्ट आणि मॉडर्न ॲग्री-टेक CSS
st.markdown("""
<style>
...
# येथे तुमची मघाशी कॉपी केलेली Google AI Studio ची Key पेस्ट करा:
API_KEY = "TUMCHI_GEMINI_API_KEY_ETHE_PASTE_KARA"
...
# ६. जलद (Fast Compressed) स्वयंचलित विश्लेषण
if uploaded_file is not None:
    image = Image.open(uploaded_file).convert('RGB')
    st.image(image, caption="विश्लेषणासाठी निवडलेले छायाचित्र", use_container_width=True)

    # नेटवर्क ट्रान्सफर वेग वाढवण्यासाठी कॉम्प्रेस करणे:
    fast_image = image.copy()
    fast_image.thumbnail((512, 512))

    with st.spinner("⚡ AI सेकंदात सखोल विश्लेषण करत आहे..."):
        try:
            analysis_prompt = """
            तुम्ही कृषी शास्त्रज्ञ आहात. या फोटोचे निरीक्षण करून खालील फॉरमॅटमध्ये थेट व संक्षिप्त मराठीत उत्तर द्या:
            ...
            * **लक्षणे:** [१-२ ओळीत संक्षिप्त वर्णन]
